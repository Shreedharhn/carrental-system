...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>The Freedom of self Driving to anywehere <span><h2>DSCE Cars For You</h2></span></h2>
    ...
    <div class="row">  
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">CHECK OUT THE WIDE RANGE OF CARS</a></li>
        </ul>
      </div>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Our Satisfied <span><h2>DCSE Customers</h2></span></h2>
    </div>
    <div class="row">
